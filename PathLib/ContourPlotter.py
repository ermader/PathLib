...
class ContourPlotter(GlyphPlotterEngine.GlyphPlotterEngine):
    ...
    colorLightGrey = Color.fromName("lightgrey")
    colorBlack = Color.fromName("black")
...
#
#     cp.drawContours([testContour], GTColor.fromName("red"), False)
#
...
#     pcp.drawContours([testContour], GTColor.fromName("green"), False)
#
